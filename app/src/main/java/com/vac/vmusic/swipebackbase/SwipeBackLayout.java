package com.vac.vmusic.swipebackbase;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private BaseSwipeBackFragment mFragment;
    ...
    public void setFragment(BaseSwipeBackFragment fragment, View view) {
    ...
    public void attachToFragment(BaseSwipeBackFragment swipeBackFragment, View view) {
        addView(view);
    ...
    class ViewDragCallback extends ViewDragHelper.Callback {
            ...
            if (dragEnable) {
                ...
                if (mPreFragment == null) {
                    if (mFragment != null) {
                        ...
                        Log.e("TAG","mFragment==null dasdadsfa");
                    }
                } else {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent > 1) {
                if (mFragment != null) {
                    if (mPreFragment instanceof BaseSwipeBackFragment) {
                        ((BaseSwipeBackFragment) mPreFragment).mLocking = true;
                    }
                    ...
                    if (mPreFragment instanceof BaseSwipeBackFragment) {
                        ((BaseSwipeBackFragment) mPreFragment).mLocking = false;
                    }
                } else {
        ...
        public int getViewHorizontalDragRange(View child) {
            if (mFragment != null) {
                return 1;
            } else if (mActivity != null && ((BaseActivity) mActivity).swipeBackPriority()) {
                return 1;
            }
