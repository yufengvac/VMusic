package com.vac.vmusic.nativemusicfragment.model;
 ...
 *
 */
public class NativeMusicModel {
    public void loadData(final Context context, final OnLocalMusicLoadListener listener){
