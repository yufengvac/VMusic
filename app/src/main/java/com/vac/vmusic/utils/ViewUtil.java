...
public class ViewUtil {
    ...
    public static void showRefreshLayout(View view,String text){
        view.setVisibility(View.VISIBLE);
        imageView = (ImageView) view.findViewById(R.id.refresh_layout_image);
        if (text!=null&&!text.isEmpty()){
            TextView textView = (TextView)view.findViewById(R.id.refresh_layout_text);
            textView.setText(text);
        }
        AnimationDrawable animationDrawable = (AnimationDrawable) imageView.getDrawable();
        animationDrawable.start();
    }
    public static void hideRefreshLayout(View view){
        if (imageView==null){
            imageView = (ImageView) view.findViewById(R.id.refresh_layout_image);
        }
