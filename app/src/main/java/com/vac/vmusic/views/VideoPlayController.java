...
//    }
        ...
        mContentView = LayoutInflater.from(mContext)
                .inflate(R.layout.my_media_controller1, null, false);

        final View bottomView = mContentView.findViewById(R.id.my_medial_controller1_bottom);
        ...
        mCurrentTimeTv = (TextView) mContentView.findViewById(R.id.mediacontroller_time_current);
        mTotalTimeTv = (TextView) mContentView.findViewById(R.id.mediacontroller_time_total);

        mSeekBar = (SeekBar) mContentView.findViewById(R.id.mediacontroller_seekbar);
        mSeekBar.setOnSeekBarChangeListener(mOnSeekBarChangeListener);

        mPlayButton = (ImageView) mContentView.findViewById(R.id.mediacontroller_play_pause);
        mPlayButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!v.isSelected()) {
        ...
        mCloseButton = (ImageView) mContentView.findViewById(R.id.my_medial_controller1_back);
        mCloseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mContext.finish();
        ...
        mFullScreenButton = (ImageView) mContentView.findViewById(R.id.full_screen);
        mFullScreenButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ViewUtil.rotateScreen(mContext);
    ...
    private SeekBar.OnSeekBarChangeListener mOnSeekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            // 停止拖动
            Log.e("VideoPlayController","调到 " + StringUtils
